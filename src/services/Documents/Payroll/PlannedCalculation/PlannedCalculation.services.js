...
const baseUrl = "PlannedCalculation/";

const PlannedCalculationServices = {
  ...
  getTableData(OwnerID) {
    return ApiServices.get(`${baseUrl}GetTableData?OwnerID=${OwnerID}`
    );
  },
...
export default PlannedCalculationServices;
