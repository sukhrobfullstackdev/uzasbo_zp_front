...
const baseUrl = "ContractOfScholarship/";

const ContractOfScholarshipServices = {
  ...
  postDataCalTableData(allTableData) {
    return ApiServices.post(`${baseUrl}CalculateContractOfScholarshipSum?Calculate=true`, allTableData);
  },
  Accept(id) {
...
export default ContractOfScholarshipServices;
