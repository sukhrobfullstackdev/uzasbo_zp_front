...
const baseUrl = "SubjectsInBLHGT/";

const SubjectsInBLHGTApis = {
  getList(payload) {
  ...
  getAllSubjectsInBLHGTList(payload) {
    return ApiServices.get(`${baseUrl}GetAllSubjectsInBLHGTList`, {params: payload});
  },

};

export default SubjectsInBLHGTApis;
