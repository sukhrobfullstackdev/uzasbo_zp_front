...
const ViewStaffList = React.lazy(() => import('../App/views/Documents/Personnel_accounting/StaffingTable/StaffList/ViewStaffList'));
...
const StaffListRegisterySend = React.lazy(() => import('../App/views/Documents/Personnel_accounting/StaffingTable/StaffListRegisterySend/StaffListRegisterySend'));
const StaffListRegisteryReceived = React.lazy(() => import('../App/views/Documents/Personnel_accounting/StaffingTable/StaffListRegisteryReceived/StaffListRegisteryReceived'));
const StaffListAdmin = React.lazy(() => import('../App/views/Documents/Personnel_accounting/StaffingTable/StaffListAdmin/StaffListAdmin'));
const IndexByOblast = React.lazy(() => import('../App/views/Documents/Personnel_accounting/StaffingTable/IndexByOblast/IndexByOblast'));
...
const ViewClassTitle = React.lazy(() => import('../App/views/Documents/Personnel_accounting/TariffList/ClassTitle/ViewClassTitle'));
// ClassRegisteryTitle
...
const ViewBillingListReceived = React.lazy(() => import('../App/views/Documents/Personnel_accounting/TariffList/BillingListReceived/ViewBillingListReceived'));
...
//Ochot
const AccountBookList = React.lazy(() => import('../App/views/Report/Turnover statement/AccountBookList/AccountBookByEmployee.js'));
...
const routes = [
  ...
  { path: '/subCalculationKind/edit/:id', exact: true, name: 'EditSubCalculationKind', component: UpdateSubCalculationKind, role: 'SubCalculationKindView' },//SubCalculationKindEdit
  ...
  { path: "/limitBySubCalculationKind/edit/:id", exact: true, name: "UpdateSubCalc", component: UpdateSubCalc, role: "LimitBySubCalculationKindView",},
  ...
  { path: '/StaffList/view/:id', exact: true, name: 'ViewStaffList', component: ViewStaffList, role: 'StaffListView' },
  { path: '/StaffListReceived', exact: true, name: 'StaffListReceived', component: StaffListReceived, role: 'StaffListRegisteryReceived' },
  { path: '/IndexStaffListRegistery', exact: true, name: 'IndexStaffListRegistery', component: IndexStaffListRegistery, role: 'StaffListIndexOblastView' },
  ...
  { path: '/StaffListRegisterySend', exact: true, name: 'StaffListRegisterySend', component: StaffListRegisterySend, role: 'StaffListRegisterySend' },
  { path: '/StaffListRegisteryReceived', exact: true, name: 'StaffListRegisteryReceived', component: StaffListRegisteryReceived, role: 'StaffListRegisteryReceived' },
  { path: '/StaffListAdmin', exact: true, name: 'StaffListAdmin', component: StaffListAdmin, role: 'StaffListAdminView' },
  { path: '/IndexByOblast', exact: true, name: 'IndexByOblast', component: IndexByOblast, role: 'StaffListIndexOblastView' },
  //Document/TariffList
  // ClassTitle
  ...
  { path: '/BillingListReceived', exact: true, name: 'BillingListReceived', component: BillingListReceived, role: 'BillingListReceivedView' },
  { path: '/BillingListReceived/view/:id', exact: true, name: 'ViewBillingListReceived', component: ViewBillingListReceived, role: 'BillingListReceivedView' },
  ...
  //Ochot 
  { path: '/AccountBook', exact: true, name: 'AccountBookList', component: AccountBookList, role: 'EmployeeView' },
