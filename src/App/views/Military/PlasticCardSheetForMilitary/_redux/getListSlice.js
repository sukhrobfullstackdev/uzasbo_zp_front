...
const initialState = {
  ...
  paginationData: {
    ...
    EndDate: moment().startOf('month').format("DD.MM.YYYY"),
  },
  filterType: null,
  filterData: {
    StartDate: moment().startOf('month').format("DD.MM.YYYY"),
...
const getListSlice = createSlice({
  name: "PlasticCardSheetForMilitaryGetList",
  initialState,
  reducers: {
...
// Reducer
const PlasticCardSheetForMilitaryReducer = getListSlice.reducer;
export default PlasticCardSheetForMilitaryReducer;