    ...
    return (
        ...
        >
            <tr>
                ...
                <th className='ant-table-cell'>
                    ...
                    >
                        <Select
                            allowClear
                            showSearch
                            placeholder={t("retrainSertSpeciality")}
                            style={{ width: '100%' }}
                ...
                <th className='ant-table-cell'>
                    <Form.Item
                        label={t('retrainSertSubjectName')}
                        name='SubjectID'
                        rules={[
                            {
                                required: true,
                    ...
                    >
                        <Select
                            allowClear
                            showSearch
                            placeholder={t("retrainSertSubjectName")}
                            style={{ width: '100%' }}
                            optionFilterProp="children"
