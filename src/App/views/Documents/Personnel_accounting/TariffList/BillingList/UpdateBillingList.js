...
const EmployeeMovement = (props) => {
    ...
    const Tables = [
        ...
        {
            title: t('CorrectiveScience'),
            children: [
                {
                    title: t('CorrectiveScience'),
                    dataIndex: 'CorrectiveScience',
                    key: 'CorrectiveScience',
                    width: 100,
                },
                {
                    title: t('CorrectiveScienceSum'),
                    dataIndex: 'CorrectiveScienceSum',
                    key: 'CorrectiveScienceSum',
                    width: 120,
                    render: record => new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(record),
                },
            ],
        },
        {
            ...
            children: [
                {
                    title: t('MethodUnion'),
                    dataIndex: 'MethodUnion',
                    key: 'MethodUnion',
                    width: 100,
                },
                {
                    title: t('MethodUnionSum'),
                    dataIndex: 'MethodUnionSum',
                    key: 'MethodUnionSum',
                    width: 120,
                    render: record => new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(record),
                },
        ...
        {
            title: t('NationalCertificate'),
            children: [
                {
                    title: t('NationalCertificate'),
                    dataIndex: 'NationalCertificate',
                    key: 'NationalCertificate',
                    width: 100,
                },
                {
                    title: t('NationalCertificateSum'),
                    dataIndex: 'NationalCertificateSum',
                    key: 'NationalCertificateSum',
                    width: 120,
                    render: record => new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(record),
                },
            ],
    ...
    const tableSummaryHandler = (records) => {
        ...
        let CorrectiveScienceSum = 0;
        let MethodUnionSum = 0;
        let NationalCertificateSum = 0;
        let Sum = 0;
        ...
        records.forEach(item => {
            ...
            CorrectiveScienceSum += +item.CorrectiveScienceSum;
            MethodUnionSum += +item.MethodUnionSum;
            NationalCertificateSum += +item.NationalCertificateSum;
            Sum += +item.Sum;
        });
        return (
            <Table.Summary.Row>
                ...
                <Table.Summary.Cell></Table.Summary.Cell>
                <Table.Summary.Cell>{new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(CorrectiveScienceSum)}</Table.Summary.Cell>
                <Table.Summary.Cell></Table.Summary.Cell>
                <Table.Summary.Cell>{new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(MethodUnionSum)}</Table.Summary.Cell>
                <Table.Summary.Cell></Table.Summary.Cell>
                <Table.Summary.Cell>{new Intl.NumberFormat('ru-RU', { maximumFractionDigits: 2, minimumFractionDigits: 2 }).format(NationalCertificateSum)}</Table.Summary.Cell>
