...
import BillingListReceivedServices from "../../../../../../services/Documents/Personnel_accounting/TariffList/BillingListReceived/BillingListReceived.services";
...
class BillingListSend extends Component {
    ...
    fetch = (params = {}, searchCode, filterFormValues) => {
        ...
        BillingListReceivedServices.getSendList(pageNumber, pageLimit, sortColumn, orderType, search, date, filter, filterFormValues)
            .then((data) => {
                this.setState({
                    loading: false,
                    data: data.data.rows,
    ...
    acceptHandler = (id) => {
        ...
        BillingListServices.AcceptReceived(id)
            .then((res) => {
                if (res.status === 200) {
    ...
    declineHandler = (id) => {
        ...
        BillingListServices.CancelReceived(id)
            .then((res) => {
                if (res.status === 200) {
    ...
    handleArchieve = (id) => {
        this.setState({ loading: true });
        BillingListServices.archieveById(id)
            .then((res) => {
                if (res.status === 200) {
