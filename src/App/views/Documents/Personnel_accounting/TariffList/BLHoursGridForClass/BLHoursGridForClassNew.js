...
const BLHoursGridForClassNew = ({ match }) => {
    const { t } = useTranslation();
    const dispatch = useDispatch();
    const [filterForm] = Form.useForm();
    const location = useLocation();

    const reduxList = useSelector((state) => state.bLHoursGridForClassList);
                    ...
                    <div className='main-table-filter-elements'>
                        ...
                        >
                            <Select
                                ...
                                {ClassNumberList.map(item => <Option key={item.ID} value={item.ID}>{item.NameUzb}</Option>)}
                            </Select>
                        </Form.Item>
                        <Form.Item
                        ...
                        >
                            <Select
                                ...
                                {ClassLangNameList.map(item => <Option key={item.Name} value={item.ID}>{item.Name}</Option>)}
                            </Select>
                        </Form.Item>
...
export default React.memo(BLHoursGridForClassNew)