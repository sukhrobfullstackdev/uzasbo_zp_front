...
import StaffTableHeaderXTV from "./StaffTableHeaderXTV";
                ...
                <Spin spinning={loading} size='large'>
                    ...
                    >
                        <Table
                            ...
                            components={{
                                header: {
                                    row: () => staffList?.SettlementAccountItemOfExpense !== "7092100075" ?
                                        <StaffTableHeader
                                            staffList={staffList}
                                            posList={posList}
                                            posQualList={posQualList}
                                            posPerList={posPerList}
                                            posSalaryTypeList={posSalaryTypeList}
                                            departmentList={departmentList}
                                            tariffScaleList={tariffScaleList}
                                            allowances={allowances}
                                            addData={addStaffTableDataHandler}
                                            minSalary={minSalary}
                                            categorygrouplist={categorygrouplist}
                                            subspecialtylist={subspecialtylist}
                                            StaffListGroupID={StaffListGroupID}
...
export default React.memo(UpdateStaffList);