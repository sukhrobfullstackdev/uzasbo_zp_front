...
const prefOrgsSlice = createSlice({
    name: "preferentialOrganizations",
    initialState,
    reducers: {
...
} = prefOrgsSlice.actions;

// Reducer
const prefOrgsListReducer = prefOrgsSlice.reducer;
export default prefOrgsListReducer;