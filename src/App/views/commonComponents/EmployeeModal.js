...
class EmployeeModal extends Component {
  ...
  fetch = (params = {}, filterValue) => {
    ...
    EmployeeServices.GetWorkingEmployeesList(pageNumber, pageLimit, sortColumn, orderType, this.props.divisionId, this.props.departmentId, filterType, filterValue)
      .then((res) => {
        this.setState({
          loading: false,
  ...
  closeModalHandler = () => {
    const { name, id, enrolmentDocumentId, PINFL } = this.state.empData
    this.props.getModalData(name, id, enrolmentDocumentId, PINFL);
    this.props.onCancel();
  }
      ...
      >
        ...
        >
          <Space size='middle'>
            <Form.Item name="filterType">
              ...
              >
                <Option value="FullName">{t("fioOwner")}</Option>
        ...
        <Table
          ...
          onRow={(record) => {
            return {
              onDoubleClick: () => {
                this.props.getModalData(record.FullName, record.ID, record.EnrolmentDocumentID, record.INPSCode);
                this.props.onCancel();
              },
              onClick: () => {
                this.setState({
