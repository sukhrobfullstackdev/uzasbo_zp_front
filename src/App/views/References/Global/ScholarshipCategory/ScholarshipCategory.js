...
const ScholarshipCategory = ({ match }) => {
    const { t } = useTranslation();
    const [filterForm] = Form.useForm();
    const dispatch = useDispatch();

    const tableList = useSelector((state) => state.ScholarCatList);
    ...
    return (
        <MainCard title={t("ScholarshipCategory")}>
            <Fade>
                <Form
                    layout='vertical'
                    form={filterForm}
...
export default React.memo(ScholarshipCategory);