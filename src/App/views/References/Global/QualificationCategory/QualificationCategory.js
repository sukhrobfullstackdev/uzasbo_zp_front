...
const QualificationCategory = ({ match }) => {
    const { t } = useTranslation();
    const [filterForm] = Form.useForm();
    const dispatch = useDispatch();

    const tableList = useSelector((state) => state.QualificationCategoryList);
    ...
    return (
        <MainCard title={t("QualificationCategory")}>
            <Fade>
                <Form
                    layout='vertical'
                    form={filterForm}
...
export default React.memo(QualificationCategory);