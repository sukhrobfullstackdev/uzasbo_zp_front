...
const Positions = ({ match }) => {
    ...
    const tableList = useSelector((state) => state.PositionList);
                ...
                >
                    <div className="main-table-filter-wrapper">
                        ...
                        >
                            ...
                            >
                                <Option value="Code1">{t("Code1")}</Option>
                                <Option value="Code2">{t("Code2")}</Option>
                                <Option value="Code3">{t("Code3")}</Option>
