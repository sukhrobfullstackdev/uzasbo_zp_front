...
const TPSalaryTransaction = ({ match }) => {
    const { t } = useTranslation();
    const dispatch = useDispatch();
    const [filterForm] = Form.useForm();
    const adminViewRole = JSON.parse(localStorage.getItem('userInfo')).Roles.includes('ChangeUserEDS');

    const tpSalaryTransactionList = useSelector((state) => state.tpSalaryTransactionList);

    let tableData = tpSalaryTransactionList.listSuccessData?.rows;
    let total = tpSalaryTransactionList.listSuccessData?.total;
    let pagination = tpSalaryTransactionList?.paginationData;
    let filter = tpSalaryTransactionList?.filterData;
        ...
        <Card title={t("TPSalaryTransaction")}>
            ...
            <Fade>
                <TableData
                    ...
                    reduxList={tpSalaryTransactionList}
...
export default React.memo(TPSalaryTransaction);