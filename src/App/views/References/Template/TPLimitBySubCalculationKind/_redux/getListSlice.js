...
import { largerMainTablePagination, initialMainTablePagination } from "../../../../../../helpers/helpers";
...
const getListSlice = createSlice({
  name: "TPLimitBySubCalculationKind",
  initialState,
  reducers: {
...
// Reducer
const TPLimitBySubCalculationKindReducer = getListSlice.reducer;
export default TPLimitBySubCalculationKindReducer;