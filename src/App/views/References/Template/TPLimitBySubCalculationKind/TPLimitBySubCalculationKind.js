...
const TPLimitBySubCalculationKind = ({ match }) => {
    const { t } = useTranslation();
    const dispatch = useDispatch();
    const [filterForm] = Form.useForm();
    const adminViewRole = JSON.parse(localStorage.getItem('userInfo')).Roles.includes('ChangeUserEDS');

    const tpLimitBySubCalcKindList = useSelector((state) => state.tpLimitBySubCalcKindList);

    let tableData = tpLimitBySubCalcKindList.listSuccessData?.rows;
    let total = tpLimitBySubCalcKindList.listSuccessData?.total;
    let pagination = tpLimitBySubCalcKindList?.paginationData;
    let filter = tpLimitBySubCalcKindList?.filterData;
        ...
        <Card title={t("TPLimitBySubCalculationKind")}>
            ...
            <Fade>
                <TableData
                    ...
                    reduxList={tpLimitBySubCalcKindList}
...
export default React.memo(TPLimitBySubCalculationKind);