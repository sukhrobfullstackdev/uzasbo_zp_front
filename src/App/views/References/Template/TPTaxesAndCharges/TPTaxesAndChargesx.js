...
import { Table, Input, Form, Tag, Select, Space, Tooltip, Button } from "antd";
...
//import classes from "./TPTaxesAndCharges.module.css";

const { Option } = Select;

class TPTaxesAndCharges extends Component {
    ...
    fetch = (params = {}, searchCode, filterFormValues) => {
        ...
        TPTaxesAndChargesServices.getList(pageNumber, pageLimit, sortColumn, orderType, search, date, filter, filterFormValues)
            .then((data) => {
                this.setState({
                    loading: false,
                    data: data.data.rows,
...
export default withTranslation()(TPTaxesAndCharges);
