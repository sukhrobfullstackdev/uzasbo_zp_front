...
const OrganizationsSettlementAccount = ({ match }) => {
    const { t } = useTranslation();
    const [filterForm] = Form.useForm();
    const dispatch = useDispatch();

    const tableList = useSelector((state) => state.OrgSettAccList);
    ...
    return (
        <MainCard title={t("OrganizationsSettlementAccount")}>
            <Fade>
                <Form
                    layout='vertical'
                    form={filterForm}
...
export default React.memo(OrganizationsSettlementAccount);