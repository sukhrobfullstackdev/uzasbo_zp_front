...
const BasicSubCalculationKind = ({ match }) => {
    const { t } = useTranslation();
    const [filterForm] = Form.useForm();
    const dispatch = useDispatch();

    const tableList = useSelector((state) => state.BasicSubCalculationKindList);
    ...
    return (
        <MainCard title={t("BasicSubCalculationKind")}>
            <Fade>
                <Form
                    layout='vertical'
                    form={filterForm}
...
export default React.memo(BasicSubCalculationKind);